...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$ErrorContext$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/contexts/ErrorContext.js [app-ssr] (ecmascript)");
'use client';
;
;
;
...
function Game1() {
    ...
    const handleWrongClick = (e)=>{
        if (!image2Ref.current || errorCount >= 3) return;
        ...
        if (clickX >= imageRect.left && clickX <= imageRect.right && clickY >= imageRect.top && clickY <= imageRect.bottom) {
            ...
            const next = targetPositions[errorCount] || {
                endX: 300,
                endY: 100
            };
            setLocalXs((prev)=>{
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            className: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$styled$2d$jsx$2f$style$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].dynamic([
                [
                    "95b7d7488ad9e09b",
                    [
                        localXs.map(({ id, startX, startY, endX, endY })=>`
              @keyframes fly-${id} {
                from {
                  left: ${startX}px;
                  top: ${startY}px;
            ...
            `).join('\n')
                ...
                localXs.map(({ id: id1, x, y }, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                        src: "/photo/X.png",
                        alt: "X",
                        style: {
                            top: `${y}px`,
            ...
            `).join('\n')
                        ...
                        ]) + " " + `absolute pointer-events-none ${idx === 0 ? 'fly-x-1' : 'fly-x-2'}`
                    }, id1, false, {
                        fileName: "[project]/src/app/game/game1/page.js",
                        lineNumber: 159,
                        columnNumber: 11
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b9c0beb8._.js.map